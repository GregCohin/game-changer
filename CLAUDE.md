...
- Bug connu : `ParentApp.jsx` (ligne ~21) lance l'upsert de `parent_profiles` sans l'attendre, donc la table reste vide et l'écran staff « Parents liés » affiche un identifiant tronqué au lieu de l'email.
