...
function MannequinPreview({ movementKey, large, proportions, style }) {
  const canvasRef = useRef(null);
  const [frameIdx, setFrameIdx] = useState(0);
  const movement = MANNEQUIN_MOVEMENTS[movementKey];
    ...
    <div>
      ...
      <div style={{ display: "flex", gap: 20, flexWrap: "wrap", alignItems: "flex-start" }}>
        <div style={{ flex: "1 1 320px", minWidth: 280, maxWidth: 420, position: "sticky", top: 10 }}>
          <MannequinPreview movementKey={selected} large proportions={proportions} style={renderStyle} />
