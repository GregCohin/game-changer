...
function emptyLibraryEntry() {
  return { id: newId(), title: "", type: "Livre", theme: "", author: "", notes: "", status: "À consulter", favorite: false, dateAdded: todayIso(), dateStatusChanged: todayIso() };
}
...
function libraryStatusDate(entry) {
  return entry.dateStatusChanged || entry.dateAdded;
}
function daysSinceStatusChange(entry) {
